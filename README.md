...
I would not use only a unit test for the full message feature because sending a message involves many parts working together, like the input, send button, server, and recipient that cannot be isolated.
